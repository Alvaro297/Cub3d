...
static void	start_cub3d(t_cub3d *cub3d, bool is_bonus)
{
...
static void	cub3d(char *argv, bool is_bonus)
{
	t_cub3d	cub3d;

	check_name(argv);
	init_cub3d(&cub3d, is_bonus);
	read_map(argv, &cub3d);
