...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-08-07 17:42:34 by alvamart          #+#    #+#             */
/*   Updated: 2025-08-07 17:42:34 by alvamart         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	wall_hit(t_cub3d *cub3d, int side, int map_x, int map_y)
{
	if (side == 0)
	{
		cub3d->raycast.perp_wall_dist = (map_x - cub3d->player.x_position
	...
	{
		cub3d->raycast.perp_wall_dist = (map_y - cub3d->player.y_position
